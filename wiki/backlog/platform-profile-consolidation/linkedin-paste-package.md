...
- SellerCanvas v1.0 전반 서비스 기획과 외주 개발 체제의 일정·산출물 관리 — 프로토타입 사용 데이터 분석으로 존치·변경 항목 결정에서 출발
...
[Backend 표준화]
- Node.js 레거시의 NestJS 이관과 예외 처리 구조 수립, JWT 인증과 Controller→Service→DAO 흐름을 담은 팀 개발 템플릿 제작 — 현재 조직 표준 템플릿 설계의 첫 형태
