...
### Centurion · AI medical platform for dermatology operations (built from product inception)
...
- TheDayLabs · Freelance · Feb 2025 – Apr 2025: Began working with MediSolve AI's founder as a freelancer — started Centurion's early backend and set up the new dev team's systems and backend standards; joined full-time when the company was founded (`career.thedaylabs-freelance`) — ⚠️ 공식 영문 사명 미확인 (더데이랩스)
...
- STUDIO LAB · AI Engineer → PM → Backend Engineer · Dec 2021 – Jan 2024: Primary PM for SellerCanvas, a generative-AI commerce content product (CES 2024 Best of Innovation); planned and built the systems that kept the product running (`career.sellercanvas-product-system`)
