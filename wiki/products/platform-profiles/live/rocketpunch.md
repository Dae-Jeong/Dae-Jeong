---
type: platform-live-snapshot
title: RocketPunch — live 스냅샷 2026-09-03
platform: rocketpunch
captured_at: "2026-09-03"
captured_via: orca-embedded-browser
version_observed: maker-v2
---

# RocketPunch — live 스냅샷 (2026-09-03)

오늘 Orca 내장 브라우저로 읽은 **적용 전** 문안. canonical(`../rocketpunch.md`)과 같은 필드 제목을 쓴다. `/_platforms` 로컬 페이지가 before/after 비교에 읽는다. 개인 설정(희망 조건·연봉·공개 범위)은 기록하지 않는다.
