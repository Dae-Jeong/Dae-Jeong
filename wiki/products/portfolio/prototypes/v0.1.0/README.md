---
type: prototype-readme
title: Portfolio Prototype v0.1.0
description: 회사별 정적 포트폴리오 페이지의 historical visual baseline.
timestamp: 2026-07-11
tags: [portfolio, prototype, v0]
---

# Portfolio Prototype v0.1.0

현재 계약: [portfolio decisions](../../decisions.md). 이 파일은 설계 시스템이 아니라 historical visual baseline이다.

## 디자인 의도

- 이력서 v0와 **같은 아이덴티티**: 흑백 컴팩트, IBM Plex Sans KR + Plex Mono, 동일 디자인 토큰
...
이 콘텐츠의 canonical version은 [case library](../../cases/README.md)로 승격됐다. 이 prototype의 문구를 직접 수정해 canonical case로 사용하지 않는다.
