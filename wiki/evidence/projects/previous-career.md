...
- **User-confirmed (2026-09-02, supersedes 2026-08-12 Deep Scan 시기)**: Deep Scan 의류 색상·종류 분류 모델 작업은 **oopy 실측대로 AI Engineer 기간(2021.12~2022.09)**의 일이다. 구버전 원티드의 `2023.05~06` 기재는 오기이며, "PM 재직 중 직접 모델 개발" 서사는 사용하지 않는다. 공개 표현은 `Vision AI 기반 의류 이미지 분석 모델 개발`까지.
