...
### E-1. 문안 v3 전파 (2026-08-10 야간 신설)

"AI가 쓴 글 같다"는 지적으로 [문안을 v3로 재작성](../backlog/platform-profile-consolidation/dual-track-copy-draft.md#v3-재작성-2026-08-10-야간--ai가-쓴-글-같다)했다.
진단 기준표가 같은 문서에 있다 — **새 문안을 쓸 때마다 그 표로 자가 점검한다.**

- [x] 로켓펀치 — 소개 + 경력 5건 전부 v3
- [ ] **리멤버** — v2 소개가 두 탭(커넥트용·채용 서비스용)에 나가 있다
- [ ] **그룹바이** — v2 자기소개
- [ ] **링크드인** — v2 소개(About)
- [ ] **웹 이력서** `resume-view.tsx` — Summary와 Career bullet이 같은 문체다 (KO/EN 양쪽)
- [ ] 원티드 — 아직 v2도 안 들어갔으니 처음부터 v3로
