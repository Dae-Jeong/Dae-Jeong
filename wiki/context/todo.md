...
- [~] **3. 리멤버·그룹바이·링크드인 재전파** (v2 → v5.1)
  ...
  - [x] **링크드인 완료** (2026-08-11) — 줄바꿈 포맷판을 사용자가 직접 전량 반영 (소개·헤드라인·경력 6건 + typeahead 직함까지)
    - ⚠️ 수동 잔여: 아이즈솔 종료일 2021.08→2021.06 확인, 영어 프로필 신설(자동화 불가 판정), CES·특허 섹션, 직함 typeahead 4건
- [~] **4. 원티드** — v6 패키지 완성, 사용자 반영 중 · **사람인** 로그인 대기
