...
- **Infrastructure positioning correction** (2026-08-23): 회사 topology·6개 state·400+ object·10대 VM log·8개 alert 근거는 내부 evidence로 보존하지만, 사용자는 infrastructure architecture를 깊이 이해해 처음부터 설계한 전문 영역으로 포지셔닝하지 않는다. 공통 resume의 Azure 대표 성과와 public portfolio Infrastructure dossier를 제거하고, 여러 사내 서비스의 Azure·Vercel 배포 환경 구성·기본 운영 경험만 Career·Skills의 supporting signal로 남겼다. Platform variant도 cloud/SRE가 아니라 공통 backend 기반·data migration·async recovery 중심으로 바꿨다.
