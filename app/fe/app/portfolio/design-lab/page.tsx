      ...
      <Container variant="doc" className="flex-1 pb-24">
        <main data-portfolio-document data-portfolio-slug="design-lab" className="pt-8">
          ...
          <ol className="m-0 mt-6 grid list-none grid-cols-2 gap-x-8 gap-y-1 p-0 text-sm max-md:grid-cols-1">
            ...
            <li className="flex items-baseline gap-2 border-b border-border py-1.5"><span className="w-6 shrink-0 font-mono text-[11px] text-muted">09</span><a href="#tenant-boundary" className="text-[var(--portfolio-ink)] underline-offset-2 hover:underline">multi-tenant 접근 경계</a><span className="ml-auto shrink-0 font-mono text-[10.5px] text-muted">NEXUS · 비교</span></li>
            ...
            <li className="flex items-baseline gap-2 border-b border-border py-1.5"><span className="w-6 shrink-0 font-mono text-[11px] text-muted">14</span><a href="#say-overlap-sessions" className="text-[var(--portfolio-ink)] underline-offset-2 hover:underline">실시간 전사 · 겹치는 세션</a><span className="ml-auto shrink-0 font-mono text-[10.5px] text-muted">SAY · 시간축</span></li>
            <li className="flex items-baseline gap-2 border-b border-border py-1.5"><span className="w-6 shrink-0 font-mono text-[11px] text-muted">15</span><a href="#sequence-fence" className="text-[var(--portfolio-ink)] underline-offset-2 hover:underline">전사 보정 sequence fence</a><span className="ml-auto shrink-0 font-mono text-[10.5px] text-muted">SAY · 시퀀스</span></li>
