...
export const resumeType = {
  ...
  documentSection: "pt-11 max-sm:pt-9",
  identityBlock: "col-start-1 row-start-1 min-w-0",
  commonIdentityBlock:
    "flex min-w-0 flex-wrap items-baseline justify-between gap-x-8 gap-y-2",
  ...
  commonMetaBlock:
    "mt-5 grid gap-4 border-t border-border-soft pt-4 md:grid-cols-[minmax(0,1fr)_auto] md:items-start",
  profilePhoto:
  ...
  profileTitle:
    "m-0 text-pretty text-xl font-semibold leading-snug tracking-[-0.015em] text-fg",
  profileDescription: "m-0 text-pretty text-base font-normal leading-relaxed text-fg-2",
  careerRow: "border-border-soft py-4",
  achievementRow: "py-5",
  workStyleRow: "py-4",
  credentialRow: "py-2",
  achievementTitle: "m-0 mb-1.5 text-pretty text-lg font-semibold leading-snug text-fg",
  ...
  achievementEvidenceItem:
    "relative min-w-0 pl-4 before:absolute before:left-0 before:top-[0.72em] before:size-1 before:rounded-full before:bg-muted before:content-[''] [&_strong]:font-medium [&_strong]:text-fg",
