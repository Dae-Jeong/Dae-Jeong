...
export function ResumeLayout({
  ...
  return (
    <div className="relative">
      {hasCompactActions && (
        <div className="mx-auto flex w-full max-w-[920px] items-center justify-end gap-3 border-b border-border-soft py-5 print:hidden xl:hidden">
          {pdfHref && (
            <a
              href={pdfHref}
              download
      ...
      <main
        data-resume-canvas
        className={cn(
          "mx-auto w-full max-w-[920px] pb-24",
