  ...
  careers: [
    {
      ...
      details: [
        ...
        "구독형 AI 콘텐츠 제품 — Thready 아이디어 제안과 초기 프로토타입 이후 제품화·운영 주도. 기획·QA·마케팅과 함께 월 1천만원 수준의 구독 매출이 발생하는 제품 운영(2026년 8월 기준)",
  ...
  outcomes: [
    {
      ...
      description: [
        ...
        {
          text: "AI 콘텐츠 제품 아이디어를 제안하고 초기 프로토타입 이후 제품화를 주도. 기획·QA·마케팅과 함께 실제 고객이 구독하고 매출이 발생하는 제품으로 발전"
        },
        {
