...
export const JYP_PORTFOLIO = {
  ...
  introduction:
    "기획자로 시작해 백엔드로 왔고, 지금은 아이디어를 제안한 AI 콘텐츠 제품을 고객이 구독하는 서비스로 만들고 운영합니다. AI 활용이 본격화되면서 모두가 메이커로 제품을 만들고 운영하는 팀에서, 백엔드 경험이 적은 팀원도 같은 기준으로 만들 수 있는 백엔드 기준을 직접 세웠습니다.",
  proofAxes: [
    {
