...
export const JYP_PORTFOLIO = {
  ...
  introduction:
    "기획자로 시작해 백엔드로 왔고, 지금은 아이디어를 제안한 AI 콘텐츠 제품을 고객이 구독하는 서비스로 만들고 운영합니다. 커머스·피부과 운영·SNS 콘텐츠 세 도메인에서 현업의 반복 업무를 제품으로 만들었고, AI 활용이 본격화되면서 모두가 메이커로 제품을 만들고 운영하는 팀이라, 백엔드 경험이 적은 팀원도 같은 기준으로 만들 수 있는 백엔드 기준을 직접 세웠습니다.",
  proofAxes: [
    {
      title: "Coding Agent를 위한 Backend 기본값",
      description:
        "백엔드 경험이 적은 팀원도 Coding Agent와 같은 구조로 운영 제품을 만들 수 있게 FastAPI 기준을 template로 만들었습니다.",
    },
    {
  ...
  cases: [
    {
      ...
      focus:
        "Local에서 드러나지 않던 session·connection pool 문제를 STG QA에서 확인한 뒤, @transactional·ContextVar session과 MVC·Hexagonal guide를 FastAPI Template으로 직접 구축했습니다.",
    ...
    },
    {
      ...
      focus:
        "사람이 반복하던 콘텐츠 제작 흐름을 재설계하고 FastAPI 백엔드·별도 AI 서비스를 직접 구현하고 주요 화면은 coding agent로 완성해 유료 제품으로 운영한 경험입니다.",
