...
export const FEATURING_PORTFOLIO = {
  ...
  introduction:
    "기획자로 시작해 백엔드로 왔고, 지금은 고객이 구독하는 AI 제품의 백엔드·AI 실행부를 직접 만들고, 핵심 화면은 coding agent로 완성해 운영합니다. AI 활용이 본격화되면서 모두가 메이커로 제품을 만들고 운영하는 팀이라, 백엔드 경험이 적은 팀원도 같은 기준으로 만들 수 있는 FastAPI 표준을 직접 세웠습니다.",
  proofAxes: [
    {
