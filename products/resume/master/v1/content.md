...
- Contact: email, phone, GitHub, 경기 안양시
...
- pipeline registry와 release gate 기반 제품팀 일정·이슈·릴리스 운영 리드 (`mediness.product-operations`)
...
- decision·spec·work·release gate로 제품 실행과 릴리스 추적 (`mediness.product-operations`)
